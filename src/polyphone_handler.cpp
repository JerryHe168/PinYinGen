...
void PolyphoneHandler::init_rules() {
    rules_ = {
        {U'行', {
            {U'行', "xíng", {{1, {U'走', U'动', U'为', U'人', U'动'}}}},
            {U'行', "háng", {{1, {U'银', U'商', U'排', U'列', U'同', U'业'}}}},
        }},
        {U'好', {
            {U'好', "hǎo", {{1, {U'人', U'事', U'处', U'友'}}}},
            {U'好', "hào", {{1, {U'爱', U'喜', U'学', U'奇'}}}},
        }},
        {U'乐', {
            {U'乐', "lè", {{1, {U'快', U'欢', U'娱', U'快'}}}},
            {U'乐', "yuè", {{1, {U'音', U'器', U'队', U'谱'}}}},
        }},
        {U'都', {
            {U'都', "dōu", {{-1, {U'是', U'有', U'在', U'要'}}}},
            {U'都', "dū", {{-1, {U'首', U'成', U'市'}}}},
        }},
        {U'长', {
            {U'长', "cháng", {{1, {U'度', U'短', U'久', U'远'}}}},
            {U'长', "zhǎng", {{1, {U'大', U'辈', U'官', U'成'}}}},
        }},
        {U'发', {
            {U'发', "fā", {{1, {U'现', U'生', U'展', U'送'}}}},
            {U'发', "fà", {{1, {U'头', U'毛', U'理'}}}},
        }},
        {U'重', {
            {U'重', "zhòng", {{1, {U'要', U'量', '点', U'大'}}}},
            {U'重', "chóng", {{1, {U'复', U'新', U'叠', U'庆'}}}},
        }},
        {U'相', {
            {U'相', "xiāng", {{1, {U'信', U'互', U'同', U'反'}}}},
            {U'相', "xiàng", {{1, {U'照', U'片', U'貌', U'片'}}}},
        }},
        {U'难', {
            {U'难', "nán", {{1, {U'题', U'度', U'过', U'受'}}}},
            {U'难', "nàn", {{1, {U'灾', U'遇', U'患'}}}},
        }},
        {U'盛', {
            {U'盛', "shèng", {{1, {U'开', U'大', U'况'}}}},
            {U'盛', "chéng", {{1, {U'饭', U'器'}}}},
        }},
        {U'地', {
            {U'地', "dì", {{1, {U'方', U'土', U'面', U'球'}}}},
            {U'地', "de", {{-1, {U'慢', U'快', U'轻', U'重', U'好', U'坏'}}}},
        }},
        {U'得', {
            {U'得', "dé", {{1, {U'到', U'体', U'力'}}}},
            {U'得', "děi", {{1, {U'可', U'必', U'须'}}}},
